...
export default function Feed({ posts, onVote }: { posts: Post[], onVote: (id: string, val: number) => void }) {
    ...
    return (
        <main className="flex-1 lg:col-span-6 w-full max-w-[480px] lg:max-w-none mx-auto flex flex-col h-full bg-dark-950/50 lg:bg-transparent lg:border-x lg:border-white/5 relative shadow-2xl lg:shadow-none">
            ...
            <header className="lg:hidden glass-panel sticky top-0 z-30 px-6 py-4 flex justify-between items-center rounded-b-3xl sm:rounded-none">
